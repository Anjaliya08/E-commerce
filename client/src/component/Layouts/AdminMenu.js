...
import { FaTh, FaBox, FaShoppingCart, FaPlusCircle,FaUserCircle } from "react-icons/fa"; // For icons
        ...
        <>
            <div className="admin-menu-container">
                <div className="list-group dashboard-menu">
                    ...
                    <NavLink to="/dashboard/admin/user" className="list-group-item list-group-item-section">
                        <FaUserCircle className="menu-icon" /> Users
                    </NavLink>
                </div>
            </div>
        </>
